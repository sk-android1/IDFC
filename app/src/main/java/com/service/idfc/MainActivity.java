...
//          String s = jsonArray.toString();
         ...
         //   in.putExtra(MyConstantKey.USER_LIST, s);
            UserListSingelton.userListStr = jsonArray.toString();         // using this approach for large data parsing
        ...
        binding.tvRetailer.setOnClickListener(v -> {
            ...
            in.putExtra(MyConstantKey.COM_TYPE, "Relipay");      // pass Vidcom or Relipay
            in.putExtra(MyConstantKey.LOGIN_TYPE, "APP");      // pass   APP, RelipaySDK, VidcomSDK
