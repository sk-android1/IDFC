...
public class DeliveredDocumentUploadFragmentNew extends Fragment {

    FragmentDeliveredDocumentUploadNewBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentDeliveredDocumentUploadNewBinding.inflate(inflater);
    ...
    private void clickEvents() {
        ...
        binding.tvSubmit.setOnClickListener(v -> {
            if (latitude.equalsIgnoreCase("") || longitude.equalsIgnoreCase("") || latitude.equalsIgnoreCase("0.0") || longitude.equalsIgnoreCase("0.0")) {
                MyErrorDialog.nonFinishErrorDialog(activity, "Location not found try again.");
                getLocationLatLang();
            } else {
                submitDocument();
            }
    ...
    private void updateCount(EditText etCount) {
        ...
        RetrofitClient.getInstance().getApi().updateDocumentCount(leadId, retailerId, strCount, jobSubType,geoCode)
                .enqueue(new Callback<JsonObject>() {
                    @SuppressLint("SetTextI18n")
                    @Override
                    public void onResponse(@NonNull Call<JsonObject> call, @NonNull Response<JsonObject> response) {
    ...
    private void startAddressFetcherService() {
        ...
        DeliveredDocumentUploadFragmentNew.AddressResultReceiver addressResultReceiver = new DeliveredDocumentUploadFragmentNew.AddressResultReceiver(new Handler());
