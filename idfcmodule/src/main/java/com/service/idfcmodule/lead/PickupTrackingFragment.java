...
public class PickupTrackingFragment extends Fragment {
    ...
    String job_type, jobSubType, delivery, pickup_address, pickup_time;
...
//                            }
    ...
    private void OnGPS() {
        ...
        View convertView = getLayoutInflater().inflate(R.layout.device_not_connected, null);
    ...
    private class AddressResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            if (resultCode == 0) {
                ...
                if (isButtonClicked) reachedLocation();
